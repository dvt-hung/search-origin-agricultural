...
public class InsertProductFarmerActivity extends AppCompatActivity implements ChoiceType_Adapter.IListenerChoiceType, IInsertProduct {
    ...
    public void onClickChoiceType(Object obj) {
        ...
        {
            product.setIdCategory(((Category) obj).getIdCategory());
            txt_ResultCategory_InsertProduct.setText(((Category) obj).getNameCategory());

        }
        else if (obj.getClass() == Balance.class)
        {
            txt_ResultBalance_InsertProduct.setText(((Balance) obj).getNameBalance());
            product.setIdBalance(((Balance) obj).getIdBalance());
        }
